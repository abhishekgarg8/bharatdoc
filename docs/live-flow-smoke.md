...
Use this smoke to validate real Supabase password auth plus the end-to-end BharatDoc worker flow.
...
- The script creates unique owner/doctor Supabase Auth users and clinic records for each run.
